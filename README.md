...
You can check out live demo from [here](http://webmag.minthantoo.com)
...
To access admin page, go to `/login`. In live demo site click [here](http://webmag.minthantoo.com/login). Email is `minthantoo.ardil@gmail.com` and password is `password`.
