...
class HomeController extends Controller
{
     ...
     * @return Application|Factory|View
     */
    public function blog_view(Request $request, $slug)
    {
    ...
    public function blogs(IndexBlogsRequest $request)
    {
        ...
        $blogs = $blogs->paginate($request->get('per_page') ?? 5)->withQueryString();
    ...
    public function store_contact_message(StoreContactMessageRequest $request): RedirectResponse
    {
        ...
        return to_route('blog.contact')->with('success', 'Message received. We will get in touch with you soon.');
    }
