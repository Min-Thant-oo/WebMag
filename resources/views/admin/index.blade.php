                            ...
                            @foreach($popular_blogs as $blog)
                                <a href="{{ route('admin.blog.edit', $blog->id) }}" class="col-12 d-flex p-1 c-grey-100 mb-3">
                                    <div class="blog pl-3 mr-3">
                                        <img src="{{ $blog->thumbnailUrl }}" style="height: 150px; width: 200px; object-fit: cover" alt="{{ $blog->title }}">
                                    </div>
                    ...
                    <div class="mT-30">
                        <div class="row px-3">
                            @foreach($recent_comments as $comment)
                                <a href="{{ route('admin.comment.edit', $comment->id) }}" class="col-12 d-flex p-2 c-grey-100 mb-3 border-gray-200 border-radius-10px">
                                    <div class="px-2 flex-grow-1">
